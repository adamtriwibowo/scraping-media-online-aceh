  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Kelola Website</h1>
              ...
              <TableBody>
                {sites.map((site) => (
                  <TableRow key={site.id}>
                    <TableCell>
                      <div className="flex flex-col">
                        ...
                        <a
                          ...
                          className="truncate text-xs text-muted-foreground hover:text-primary max-w-[220px]"
                        >
                          {site.url}
                        </a>
                      </div>
                    ...
                    <TableCell>
                      <Badge variant={site.category === "nasional" ? "default" : "secondary"}>
                        {site.category}
                      </Badge>
                    </TableCell>
                    <TableCell>
